...
import ModalForm from "@/common/components/auth/modal-form";
      ...
      <div className="!pointer-events-none flex flex-1 flex-col items-stretch">
        <div className="!pointer-events-none relative flex flex-1 flex-col">
          <div className="pointer-events-auto absolute left-0 right-0 top-0 z-1">
            ...
            <div className="!pointer-events-none fixed left-0 right-0 flex flex-col items-stretch backface-hidden">
              <div className="!pointer-events-none flex shrink-0 basis-auto flex-col items-stretch">
                <div className="!pointer-events-none flex shrink-0 basis-auto flex-col items-stretch">
                  <div className="pointer-events-auto relative bottom-0 left-0 right-0 top-0 block shrink-0 basis-auto">
                    <div className="relative bottom-0 left-0 right-0 top-0 z-0 m-0 block min-h-0 min-w-0 p-0">
                      <div className="flex flex-col items-stretch">
                        ...
                        <div
                          tabIndex={0}
                          className="fixed top-0 flex h-full w-screen shrink-0 basis-auto flex-row items-center justify-center"
                        >
                          <div className="fixed bottom-0 left-0 right-0 top-0 flex shrink-0 basis-auto flex-col items-stretch bg-shadow"></div>
                          <ModalForm />
                        </div>
                        <div
                          tabIndex={0}
            ...
            <main className="flex shrink grow basis-auto flex-col items-stretch">
              <div className="flex shrink grow basis-auto flex-col items-stretch">
                <div className="flex flex-1 flex-col items-stretch">
                      ...
                      <div className="flex w-full min-w-[27.313rem] max-w-[47.5rem] shrink-0 basis-auto flex-col items-stretch p-5">
                        ...
                        <div className="flex shrink-0 basis-auto flex-col items-stretch">
                          ...
                          <div className="mt-10 flex shrink-0 basis-auto flex-col items-stretch">
                            ...
                            <Link
                              href="/login"
                              className="mb-2 flex h-10 min-h-9 w-[18.75rem] min-w-9 max-w-[23.75rem] select-none flex-col items-stretch rounded-full border border-lightblue px-4 transition-all duration-200 flex-0 hover:bg-lightblue-hover"
                            >
                  ...
                  <div className="mb-0 flex shrink-0 basis-auto flex-col items-stretch transition-margin-bottom duration-100">
